...
########## DEG tables ####################
######### limma HIV-RV table
dd2 <- read.csv2("publication_Limma_HIV_vs_HIV_RVI_170720.csv", header=T)
names(dd2)
head(dd2)
dim(dd2)
######### limma Tsalik table
dd3 <- read.csv2("publication_Limma_Tsalik_110820.csv", header=T)
names(dd3)
head(dd3)
dim(dd3)
...
dat[1:5,c(3,16:21)]
## data description
ta <- read.table("sample_descr_github_130820.txt", header=T)
names(ta)
head(ta)
dim(ta)
table(ta[,c(2,3)])
